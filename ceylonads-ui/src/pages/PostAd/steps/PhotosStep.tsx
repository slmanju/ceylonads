...
import type { CategoryResponse, MediaResponse } from "../../../types/api";
...
export function PhotosStep({
  ...
  // Tuition ads are commonly promoted with a portrait poster (teacher photo, subject,
  // schedule, contact) rather than a landscape photo - surfaced only as guidance, uploads of
  // any ratio are still accepted.
  ...
  return (
    <div className="post-ad-step">
      ...
      <p className="post-ad-step__subtitle">
        Ads with photos get more responses. The first photo will be used as the cover image.
        {isTuition && " Recommended poster ratio: 4:5. Portrait posters work best for tuition ads."}
      </p>
