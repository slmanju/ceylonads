...
// Isolated Tuition-only search (source channel TUITION), for the Tuition search results grid -
// see TuitionClassController#search. Same filter/sort/attribute shape as searchAds.
