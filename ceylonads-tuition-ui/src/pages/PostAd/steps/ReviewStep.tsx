    ...
    <div className="post-ad-step">
      ...
      <div className="review-step">
        <div className="review-step__row">
          <div>
            <p className="review-step__label">Class Type</p>
        ...
        <div className="review-step__row">
          <div>
            ...
            {filledAttributes.length > 0 && (
              <>
                <p className="review-step__label review-step__label--spaced">Class Details</p>
            ...
            <p className="review-step__label review-step__label--spaced">Fee</p>
          ...
          <div>
            ...
            {hasContactOverride ? (
              <>
                ...
                {whatsappNumber !== "" && (
                  <p className="review-step__value">WhatsApp: {whatsappNumber === phoneNumber ? "same number" : whatsappNumber}</p>
                )}
              </>
            ) : (
      ...
      {failedPhotos.length > 0 && (
        <p className="post-ad-form__error">
          <FaExclamationTriangle aria-hidden="true" /> {failedPhotos.length} photo(s) failed to upload. You can retry from the Photos step.
        </p>
      )}
