...
export function DetailsStep({
  ...
  return (
    <div className="post-ad-step">
      <h2 className="post-ad-step__title">Tell students about your class</h2>
      <p className="post-ad-step__subtitle">{categoryPath ? `Class type: ${categoryPath}` : "Add the details students need to know."}</p>
      ...
      <div className="post-ad-form">
        <div className="post-ad-form__field">
          ...
          <input
            id="ad-title"
            type="text"
            placeholder="e.g. A/L Combined Mathematics - Online & Physical"
            value={title}
            maxLength={180}
        ...
        <div className="post-ad-form__field">
          <label htmlFor="ad-price">Fee (Rs. / month) (optional)</label>
          <input
            id="ad-price"
            type="number"
            inputMode="decimal"
          ...
          <div className="post-ad-form__hint-row">
            {errors.price ? (
              ...
              <span className="post-ad-form__hint">Leave blank if you prefer students to contact you for the fee.</span>
            )}
          </div>
        </div>
        ...
        <div className="post-ad-form__field">
          ...
          <textarea
            id="ad-description"
            rows={6}
            placeholder="Describe your class - syllabus coverage, teaching style, past results, why students should join…"
            value={description}
            maxLength={5000}
        ...
        <div className="post-ad-contact">
          ...
          <div className="post-ad-form__field">
            ...
            <div className="post-ad-form__hint-row">
              {errors.phoneNumber ? (
                ...
                phoneNumber.trim() === "" && accountPhone && <span className="post-ad-form__hint">Using account number: {accountPhone}</span>
              )}
            </div>
          </div>
            ...
            <div className="post-ad-form__field">
              ...
              <div className="post-ad-form__hint-row">
                {errors.whatsappNumber ? (
                  ...
                  whatsappNumber.trim() === "" && accountPhone && <span className="post-ad-form__hint">Using account number: {accountPhone}</span>
                )}
              </div>
            </div>
          )}
          ...
          <div className="post-ad-form__field">
            ...
            <input
              id="ad-contact-name"
              type="text"
              placeholder="Name students should ask for"
              value={contactName}
              maxLength={120}
            ...
            <div className="post-ad-form__hint-row">
              {errors.contactName ? (
                ...
                contactName.trim() === "" && accountDisplayName && <span className="post-ad-form__hint">Using account name: {accountDisplayName}</span>
              )}
            </div>
          </div>
        </div>
